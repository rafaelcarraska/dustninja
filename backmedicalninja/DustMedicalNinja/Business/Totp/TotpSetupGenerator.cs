using DustMedicalNinja.Business.Totp.Helper;
...
namespace DustMedicalNinja.Business.Totp
{
    public class TotpSetupGenerator
    {
        ...
        public TotpSetupViewModel Generate(string issuer, string accountIdentity, string accountSecretKey, int qrCodeWidth = 300, int qrCodeHeight = 300, bool useHttps = true)
        {
            ...
            var totpSetup = new TotpSetupViewModel
            {
        ...
        private string GetQrImage(string url, int timeoutInSeconds = 60)
        {
            try
            {
